...
class MultiverseSimulationLaunch(MultiverseLaunch):
    ...
    def run_simulator_compiler(self, compiler_name, simulation_name, simulation_data):
        ...
        multiverse_src_dir = os.path.join(os.path.dirname(current_file), "..", "src")
        simulator_compile_file = os.path.join(multiverse_src_dir, "multiverse_connectors", "multiverse_simulators_connector", "scripts", f"{compiler_name}.py")
    ...
    def run_simulator(self, compiler_result: subprocess.CompletedProcess, simulation_name,
        ...
        current_file = os.path.abspath(__file__)
        multiverse_src_dir = os.path.join(os.path.dirname(current_file), "..", "src")
        simulator_file = os.path.join(multiverse_src_dir, "multiverse_connectors", "multiverse_simulators_connector", "scripts", f"{simulation_data['simulator']}.py")
